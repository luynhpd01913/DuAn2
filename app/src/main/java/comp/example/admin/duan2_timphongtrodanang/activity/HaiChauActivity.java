...
public class HaiChauActivity extends AppCompatActivity {
    Toolbar toolbarHC;
    ListView lvHC;
    LienchieuAdapter haichauAdapter;
    ArrayList<Phongtro> mangptHaiChau;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hai_chau);
        Anhxa();
        getIDloaiPhongTro();
        ActionToolbar();
        GetData(page);
    ...
    private void LoadMoreData() {
        lvHC.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                intent.putExtra("thongtinphongtro",mangptHaiChau.get(i));
    ...
    private void GetData(int Page) {
        ...
        String duongdan= Server.DuongdanHoaVang+String.valueOf(Page);
        StringRequest stringRequest = new StringRequest(Request.Method.POST, duongdan, new Response.Listener<String>() {
                ...
                if(response != null && response.length() != 2){
                    ...
                    try {
                        ...
                        for (int i = 0;i<jsonArray.length();i++){
                            ...
                            mangptHaiChau.add(new Phongtro(id,Tenpt,Giapt,Hinhanhpt,Mota,Diachipt,Sdtpt,Idkvpt));
                            haichauAdapter.notifyDataSetChanged();
                        }
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                param.put("idsanpham",String.valueOf(idHC));
                return param;
            }
        };
    ...
    private void getIDloaiPhongTro() {
        idHC = getIntent().getIntExtra("idphongtro",-1);
        Log.d("giatriloaiphongtro",idHC+"");
    }

    private void Anhxa() {
        toolbarHC = findViewById(R.id.toolbarHaiChau);
        lvHC =findViewById(R.id.listviewHaiChau);
        mangptHaiChau = new ArrayList<>();
        haichauAdapter = new LienchieuAdapter(getApplicationContext(),mangptHaiChau);
        lvHC.setAdapter(haichauAdapter);
